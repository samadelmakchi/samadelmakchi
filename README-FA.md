...
|------------------|--------------------|
| 🐍 **Python** | میکروسرویس با FastAPI & Flask، ORM با SQLAlchemy، مدیریت پکیج با pip، مستندسازی با Sphinx & docstrings، تست با Pytest, Unittest, Mock |
...
| 📦 **Composer / NPM / pip** | مدیریت بسته و وابستگی‌ها |
...
|-----------------------|--------------------------|----------------------|----------------------------------------------------------|
| **Nikan Mehr Pardazesh Afza** | DevOps Engineer | تیر ۱۴۰۲ – حالا | طراحی و پیاده سازی معماری میکروسرویس و مانیتورینگ سرویس ها |
| **Ekeep Startup** | Project Manager & Scrum Master | آبان ۱۳۹۸ – تیر ۱۴۰۲ | مدیریت پروژه‌ها و تیم‌های چندتخصصی و هدایت برنامه‌ریزی اسپرینت‌ها و فرآیندهای Agile |
